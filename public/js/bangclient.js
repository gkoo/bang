...
GameController = function() {
  var controller = {
    ...
    setupViews: function() {
      var playersColl = new PlayersCollection();
      this.model.set({ playersColl: playersColl });
      this.playersView = new PlayersView({ collection: playersColl });
    ...
    handleInitInfo: function(o) {
      var userPlayer,
          playersColl = this.model.get('playersColl');
